...
const OrderSchema = Type.Optional(
  Type.Object({
    amount: Type.Optional(Type.Number()),
...
const ApplicableToSchema = Type.Object({
  ...
  effect: Type.Union([
    Type.Literal('APPLY_TO_EVERY'),
    Type.Literal('APPLY_TO_CHEAPEST'),
    Type.Literal('APPLY_TO_MOST_EXPENSIVE'),
  ]),
...
export const BalanceResponseSchema = Type.Object({
  status: StatusSchema,
  amount: AmountSchema,
  redeemables: Type.Optional(
    Type.Array(
      Type.Object({
        id: Type.String(),
        object: Type.String(),
        order: OrderSchema,
        applicable_to: Type.Optional(
          Type.Object({
